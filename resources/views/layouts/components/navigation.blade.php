<nav x-data="{ open: false }" class="bg-white border-gray-100">
    ...
    <div class="">
        <div class="grid grid-cols-6 h-16">
            <div class="flex bg-blue-900">
                <!-- Home Link -->
                <div class="hidden space-x-8 w-full sm:flex">
                    <x-breeze.nav-link :href="route('home')" :active="request()->routeIs('home')" class="w-full justify-center text-white">
                        {{ __('Home') }}
                    </x-breeze.nav-link>
                </div>
            </div>
            <!-- Settings Dropdown -->
            <div class="col-start-6 justify-end hidden sm:flex sm:items-center">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-breeze.responsive-nav-link :href="route('home')" :active="request()->routeIs('home')">
                {{ __('Home') }}
